	...
	<div class="flex min-h-0 flex-1 flex-col p-5 pb-10">
		...
		>
			<div class="flex items-center gap-3">
				<div style="width:4px;height:30px;background:#DB2B3A;border-radius:2px;flex:none;"></div>
				<div>
					<div style="font-family:var(--cse-font-display),'Saira Condensed',sans-serif;font-weight:700;font-size:26px;letter-spacing:0.03em;text-transform:uppercase;color:#131C3F;line-height:1;">
						{{ __('All Courses') }}
					</div>
					<div style="font-size:13px;color:#5A6378;margin-top:3px;">
						{{ __("Everything you're training, finished, or own.") }}
					</div>
				</div>
			</div>
			<div
